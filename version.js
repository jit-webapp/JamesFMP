...
// เวอร์ชันหลัก
var APP_VERSION = 'v8.7.16';
var APP_LAST_UPDATED = '29-03-2026';
var APP_LAST_UPDATED_TH = '29 มีนาคม 2569';

// ช่องสำหรับพิมพ์รายละเอียดการอัปเดต (ให้พิมพ์ไว้ในเครื่องหมาย ` `)
var APP_UPDATE_NOTES = `
<b>⚙️ รายการอัพเดท </b>
- อัพเดทระบบแชทบอทให้ฉลาดยิ่งขึ้น
- เพิ่มความสามารถคำสั่งที่สอนให้ใส่จำนวนเงินเพิ่มได้
- เพิ่มความสามารถคำสั่งที่สอนให้ใส่คำอธิบายเพิ่มได้
`;
