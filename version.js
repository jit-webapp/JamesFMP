...
- แก้ไขบัคไม่จับเวลาล๊อคหน้าจอ
- แก้ไขบัคสแกนนิ้วไม่ได้หลังจากพักแอป
- แก้ไขบัคกระดิ่งไม่แจ้งเตือนหลับอัพเดท
- แก้ไขบัคไม่มีเสียงพูดบน ios
`;
