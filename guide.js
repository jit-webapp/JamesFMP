			...
			<section id="start" class="bg-white dark:bg-gray-800 rounded-3xl shadow-xl overflow-hidden border border-gray-100 dark:border-gray-700 transition-colors scroll-mt-24">
				<div class="bg-gradient-to-r from-purple-600 to-indigo-600 p-6 flex items-center gap-4 hover:opacity-90 transition-opacity relative">
					...
					<button class="speak-btn absolute top-4 right-4 bg-white/20 hover:bg-white/30 text-white p-2 rounded-full transition-colors" 
						data-speak="หัวข้อเริ่มต้นใช้งาน อธิบายเกี่ยวกับหน้าจอต้อนรับสำหรับผู้ใช้ใหม่ วิธีการติดตั้งแอปพลิเคชันในรูปแบบ PWA ทั้งบน Android และ iPhone, การตั้งรหัสผ่านด้วยตนเองเนื่องจากระบบไม่มีรหัสผ่านเริ่มต้นให้แล้ว เพื่อความปลอดภัยสูงสุดของคุณ, และการเปิดใช้งาน Biometric หรือสแกนนิ้วใบหน้าเพื่อความสะดวกในการเข้าใช้งาน นอกจากนี้ยังมีเคล็ดลับการใช้ Biometric ร่วมกับ Auto Lock">
						<i class="fa-solid fa-volume-high text-xl"></i>
					</button>
				</div>
				<div class="p-8 space-y-6">
					
					<div class="flex flex-col md:flex-row gap-6 items-start relative border-b border-gray-100 dark:border-gray-700 pb-6">
						<div class="md:w-1/4 flex justify-center">
							<div class="w-32 h-32 bg-yellow-50 dark:bg-yellow-900/20 rounded-3xl flex items-center justify-center text-5xl text-yellow-600 dark:text-yellow-400 border-2 border-yellow-200 dark:border-yellow-800">
						...
						<div class="md:w-3/4">
							<h3 class="text-2xl font-bold text-gray-800 dark:text-gray-200 mb-3 flex items-center gap-2">
								...
								หน้าต้อนรับ (Welcome Screen)
								<button class="speak-btn ml-2 text-yellow-600 hover:text-yellow-800 dark:text-yellow-400" 
									data-speak="เมื่อเข้าใช้งานแอปพลิเคชันครั้งแรก ระบบจะแสดงหน้าต่างต้อนรับเพื่อแนะนำขั้นตอนที่สำคัญ 2 อย่าง คือ การตั้งรหัสผ่านเพื่อความปลอดภัย และการติดตั้งแอปพลิเคชันลงเครื่อง คุณสามารถทำตามคำแนะนำหรือกดข้ามเพื่อเริ่มใช้งานทันทีก็ได้">
									<i class="fa-solid fa-volume-high"></i>
								</button>
							</h3>
							<p class="text-gray-600 dark:text-gray-300 text-lg leading-relaxed mb-3">
					...
					<div class="grid md:grid-cols-2 gap-6 mt-4">
						<div class="bg-gray-50 dark:bg-gray-700/50 p-6 rounded-2xl relative">
							<div class="flex items-center gap-3 mb-4">
								...
								<h4 class="text-xl font-bold text-gray-800 dark:text-gray-200">การตั้งรหัสผ่าน
									<button class="speak-btn ml-2 text-green-600 hover:text-green-800 dark:text-green-400" 
										data-speak="ปัจจุบันระบบไม่มีรหัสผ่านเริ่มต้นให้แล้ว เพื่อความปลอดภัยสูงสุด คุณจะต้องเป็นผู้กำหนดรหัสผ่านด้วยตนเองเมื่อเข้าใช้งานครั้งแรก หากต้องการตั้งรหัสผ่านหรือเปลี่ยนรหัสผ่านในภายหลัง สามารถเข้าไปที่เมนูตั้งค่าและเลือก จัดการรหัสผ่าน">
										<i class="fa-solid fa-volume-high"></i>
									</button>
								</h4>
							</div>
